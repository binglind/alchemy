...
import { UdfComponent } from 'app/entities/udf/udf.component';
import { UdfService } from 'app/entities/udf/udf.service';
import { Udf } from 'app/shared/model/udf.model';

describe('Component Tests', () => {
  describe('Udf Management Component', () => {
    let comp: UdfComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.udfs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
