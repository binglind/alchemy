...
import { SinkComponent } from 'app/entities/sink/sink.component';
import { SinkService } from 'app/entities/sink/sink.service';
import { Sink } from 'app/shared/model/sink.model';

describe('Component Tests', () => {
  describe('Sink Management Component', () => {
    let comp: SinkComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SinkComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sinks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
